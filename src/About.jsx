...
export default function About() {
    ...
    const aboutShort = (
        <>
            <ul>
                <li>My name is Maija</li>
                <li>I'm a recent CS graduate</li>
                <li>I love to be creative</li>
                <li>I first learned HTML & CSS in 2019</li>
                <li>After 7 years I still love coding and web dev</li>
                <li>Keep scrolling to check out my projects page</li>
            </ul>
        </>
    )
        ...
        <>
            <section className='about' id='about'>
                <div className='about-top'>
                    ...
                    <div className='about-right-outer'>
                        <button className='about-toggle' onClick={() => setShowAll(p => !p)}>
                            {showAll ? 'Read more' : 'Summarize'}
                        </button>
